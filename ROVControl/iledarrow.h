...
class CIledarrow : public CWnd
{
protected:
	DECLARE_DYNCREATE(CIledarrow)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0xC2557646, 0x8194, 0x11D3, { 0x85, 0xC2, 0x0, 0x10, 0x5A, 0xC8, 0xB7, 0x15 } };
		return clsid;
	}
...
//
	...
	long get_ArrowBodyLength()
	{
		long result;
		InvokeHelper(0x3, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_ArrowBodyLength(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
